  ...
  return (
    <div className="h-10 bg-[#2c3e50] text-white flex items-center justify-between px-4 border-b border-[#34495e]">
      ...
      <div className="flex items-center gap-6 text-xs">
        <select
          className="bg-[#34495e] border border-[#4d657a] rounded px-2 py-0.5 text-[11px] text-white min-w-[min(100%,32rem)] max-w-[52rem]"
        ...
        {s && onLogout && (
          <button
            type="button"
            onClick={onLogout}
            className="px-2 py-0.5 border border-gray-400 hover:bg-[#34495e] rounded text-[11px]"
          >
            退出登录
          </button>
        )}

...
function requiredPermissionByNodeId(id: string): number {
  ...
  if (id.startsWith("assumption")) return 2;
  if (id.startsWith("forecast")) return 2;
...
const treeData: TreeNode[] = [
  ...
  },
  {
    ...
    children: [
      { id: "forecast-workbench", label: "预测预算工作台", icon: null },
      { id: "input-basic", label: "预算基础数据维护", icon: null },
      { id: "input-prediction", label: "预算预测驱动", icon: null },
  ...
  },
  {
    ...
    icon: <Database className="w-3.5 h-3.5" />,
    children: [
      { id: "assumption-basic", label: "参数与模板维护", icon: null },
    ],
  },
  {
    id: "analysis",

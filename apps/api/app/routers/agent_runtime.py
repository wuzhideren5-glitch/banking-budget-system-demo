...
def build_agent_runtime_router(
    ...
    async def agent_chat(req: AgentChatRequest, request: Request):
        ...
        dialogue_state = {
            ...
            "pending_query_spec": normalise_current_query_spec(req.pending_query_spec)
            if isinstance(req.pending_query_spec, dict)
            else None,
        }
        ...
        pending_out = normalise_current_query_spec(raw_pending) if isinstance(raw_pending, dict) else None

  ...
  const buildSubjectTree = (
    ...
    mappings.forEach((m) => {
      ...
      parent.children.push({
        ...
        type: "data",
        appliesToAllProducts: data.product_codes === null || data.product_codes === undefined || data.product_codes === "",
      });
    });
      ...
      try {
        ...
        setDataAppliesToAllByCode(
          new Map(
            dataAccounts.map((d) => [
              d.data_acct_code,
              d.product_codes === null || d.product_codes === undefined || d.product_codes === "",
            ])
          )
        );
      } catch (e) {
